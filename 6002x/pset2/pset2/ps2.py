...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        tile_x = int(pos.getX())
        tile_y = int(pos.getY())
        self.cleaned_tiles.add((tile_x, tile_y))
...
class RandomWalkRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        if self.room.isPositionInRoom(new_position):
            ...
            self.room.cleanTileAtPosition(new_position)
        self.direction = random.uniform(0, 306)
...
room = RectangularRoom(width, height)
robots = [StandardRobot(room, speed) for _ in range(num_robots)]
...
#
#       (... your call here ...)
showPlot1("Cleaning Performance: Robots vs. Time", "Number of Robots", "Cleaning Time (time steps)")
...
#
#       (... your call here ...)
showPlot2("Cleaning Time vs. Room Aspect Ratio", "Aspect Ratio (width/height)", "Cleaning Time (time steps)")
