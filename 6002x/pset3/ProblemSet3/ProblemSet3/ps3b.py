...
def simulationWithDrug(numViruses, maxPop, maxBirthProb, clearProb, resistances,
    ...
    totalVirusPopulations = np.zeros((numTrials, total_timesteps))
    resistantVirusPopulations = np.zeros((numTrials, total_timesteps))
    ...
    avgTotalVirus = np.mean(totalVirusPopulations, axis=0)
    avgResistantVirus = np.mean(resistantVirusPopulations, axis=0)
    ...
    plt.plot(timesteps, avgTotalVirus, label="Total Virus Population")
    plt.plot(timesteps, avgResistantVirus, label="Guttagonol-Resistant Virus Population")
    plt.xlabel("Time Steps")
    plt.ylabel("Average Virus Population")
    plt.title("Virus Population Dynamics with Drug Treatment")
    plt.legend(loc="best")
    plt.show()
